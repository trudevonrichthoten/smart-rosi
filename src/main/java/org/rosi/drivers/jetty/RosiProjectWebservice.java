...
public class RosiProjectWebservice {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        if( args.length < 3 ){
             System.err.println("Usagea : ... <port> <mapping> <resourceDir>");
             System.exit(4);
        }
        ...
        RosiProjectWebservice service = new RosiProjectWebservice() ;
